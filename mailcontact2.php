...
//    include 'emailstyle.css';
    ...
    $message =  $header . "" ."<br>Name:". $name . "<br>email:". $email . "<br>Company:". $company ."<br>nummer:". $mobile . "<br>message:".  $remark;
...
//    include 'emailstyle.css';
    ...
    $groet = "<p>bedankt voor het invullen van u gegevens<br>Flowda<br>0644699439<br>info.flowda.nl<br>wwww.flowda.nl</p></body>";
